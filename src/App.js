  ...
  return (
    <div className="App">
      <div className="">
        <form
          action="#"
          className="formContainer card-demo"
          data-title="Welcome!"
          data-intro="Welcome to <b>Olib!</b>👋 Here you can make personalized searches."
        >
          <div className="headerSection">
            <div
              className="container d-flex card-demo"
              data-title="Search section"
              data-intro="Type the words you want to search for and then click Go!"
            >
          ...
          <div className="container d-flex  align-items-end">
            <div
              class="mb-3 col-2 card-demo"
              data-title="Filter by date section"
              data-intro="Select the minimum year to search"
            >
              <label for="floatingInputValue" className="form-label">
                From:
              </label>
              <input
            ...
            <div
              class="mb-3 mx-2 col-2 card-demo"
              data-title="Filter by date section"
              data-intro="Select the maximum year to search"
            >
              <label for="beforeYear" className="form-label">
                To:
              </label>
              <input
            ...
            <div
              className="mb-3 col-2 card-demo"
              data-title="Language section"
              data-intro="Choose your preferred language"
            >
              <label for="floatingSelect" className="form-label">
                Language:
              </label>
              <select
                class="form-select"
            ...
            <ul
              class="nav nav-pills mx-4 mb-3 card-demo"
              data-title="Repositories section"
              data-intro="Select the repository of your preference."
              id="pills-tab"
              role="tablist"
            >
              ...
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link"
                  id="pills-scholar-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#pills-scholar"
                  type="button"
                  role="tab"
                  aria-controls="pills-scholar"
                  aria-selected="false"
                >
                  Google Scholar
                </button>
      ...
      <div className="container resultsSection">
        ...
        <div className="tab-content" id="pills-tabContent">
          <div
            className="SearchContainer tab-pane fade show active"
            id="pills-home"
            role="tabpanel"
          ...
          <div
            className="SearchContainer tab-pane fade"
            id="pills-scholar"
            role="tabpanel"
